...
// Returns the private 'App\Repository\CommentExperienceRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CommentExperienceRepository.php';

return $this->privates['App\\Repository\\CommentExperienceRepository'] = new \App\Repository\CommentExperienceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
