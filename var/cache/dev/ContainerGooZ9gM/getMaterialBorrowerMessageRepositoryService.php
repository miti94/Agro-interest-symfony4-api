...
// Returns the private 'App\Repository\MaterialBorrowerMessageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MaterialBorrowerMessageRepository.php';

return $this->privates['App\\Repository\\MaterialBorrowerMessageRepository'] = new \App\Repository\MaterialBorrowerMessageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
