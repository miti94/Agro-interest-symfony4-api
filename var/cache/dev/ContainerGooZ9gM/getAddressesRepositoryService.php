...
// Returns the private 'App\Repository\AddressesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AddressesRepository.php';

return $this->privates['App\\Repository\\AddressesRepository'] = new \App\Repository\AddressesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
