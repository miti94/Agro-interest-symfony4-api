...
// Returns the private 'App\Repository\BorrowMaterialRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BorrowMaterialRepository.php';

return $this->privates['App\\Repository\\BorrowMaterialRepository'] = new \App\Repository\BorrowMaterialRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
