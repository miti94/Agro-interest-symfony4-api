...
}, 1), ($this->privates['security.user.provider.concrete.database'] ?? $this->load('getSecurity_User_Provider_Concrete_DatabaseService.php')), 'main', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())));
