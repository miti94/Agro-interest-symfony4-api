...
include_once $this->targetDirs[3].'\\vendor\\liip\\imagine-bundle\\Imagine\\Filter\\Loader\\FixedFilterLoader.php';
...
$instance->addLoader('paste_image', new \Liip\ImagineBundle\Imagine\Filter\Loader\PasteFilterLoader($a, $this->targetDirs[3]));
...
$instance->addLoader('watermark_image', new \Liip\ImagineBundle\Imagine\Filter\Loader\WatermarkFilterLoader($a, $this->targetDirs[3]));
