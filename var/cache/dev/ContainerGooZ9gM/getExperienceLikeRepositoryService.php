...
// Returns the private 'App\Repository\ExperienceLikeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ExperienceLikeRepository.php';

return $this->privates['App\\Repository\\ExperienceLikeRepository'] = new \App\Repository\ExperienceLikeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
