 ...
 */
final class Version20200307151726 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE borrow_material CHANGE id_materail_id materail_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE borrow_material CHANGE materail_id id_materail_id INT NOT NULL');
