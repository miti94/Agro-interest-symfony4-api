 ...
 */
final class Version20200128214145 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_message (id INT AUTO_INCREMENT NOT NULL, id_message_sender_id INT DEFAULT NULL, id_message_receiver_id INT DEFAULT NULL, message LONGTEXT NOT NULL, INDEX IDX_EEB02E756DAADDBC (id_message_sender_id), INDEX IDX_EEB02E75EBC62F84 (id_message_receiver_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
