 ...
 */
final class Version20200402185626 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_message ADD id_message_sender VARCHAR(255) NOT NULL, ADD id_message_receiver VARCHAR(255) NOT NULL, DROP id_message_sender_id, DROP id_message_receiver_id');
    }
